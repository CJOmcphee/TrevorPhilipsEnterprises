...
-- Module 3, Question 2
--EXEC dbo.spQuestions @questions = 'A database is a system intended to ___, ___, and ___
--                                  large amounts of data easily.', -- varchar(1000)
--                     @answers = 'Organize, Store, and Retrieve',   -- varchar(1000)
--                     @tID = 'module3',       -- varchar(50)
--                     @crud = 'c'       -- varchar(1)

--EXEC dbo.spWrongAnswer @question = 'A database is a system intended to ___, ___, and ___
--                                  large amounts of data easily.',     -- varchar(500)
...
--EXEC dbo.spWrongAnswer @question = 'A database is a system intended to ___, ___, and ___ retrieve
--                                  large amounts of data easily.',     -- varchar(500)
...
---- Module 3, Question 9
--EXEC dbo.spQuestions @questions = 'With SQL, how do you select all the columns
--                                   from a table named "Persons"?', -- varchar(1000)
--                     @answers = 'SELECT * FROM Persons',   -- varchar(1000)
--                     @tID = 'module3',       -- varchar(50)
--                     @crud = 'c'       -- varchar(1)

--EXEC dbo.spWrongAnswer @question = 'With SQL, how do you select all the columns
--                                   from a table named "Persons"?',     -- varchar(500)
...
--EXEC dbo.spQuestions @questions = 'The OR operator displays a record if ANY conditions listed are
--                                  true. The AND operator displays a record if ALL the conditions listed
--								  are true.', -- varchar(1000)
--                     @answers = 'True',   -- varchar(1000)
--                     @tID = 'module3',       -- varchar(50)
--                     @crud = 'c'       -- varchar(1)

--EXEC dbo.spWrongAnswer @question = 'The OR operator displays a record if ANY conditions listed are
--                                  true. The AND operator displays a record if ALL the conditions listed
--								  are true.',     -- varchar(500)
--                       @wrongAnswers = 'False', -- varchar(1000)
--                       @crud = 'c'          -- varchar(1)

---- Module 3, Questions 11
--EXEC dbo.spQuestions @questions = 'With SQL, how can you delete the records where the "FirstName"
--                                   is "Peter" in the Persons Table?', -- varchar(1000)
--                     @answers = 'DELETE FROM Persons WHERE FirstName = "Peter"',   -- varchar(1000)
--                     @tID = 'module3',       -- varchar(50)
--                     @crud = 'c'       -- varchar(1)

--EXEC dbo.spWrongAnswer @question = 'With SQL, how can you delete the records where the "FirstName"
--                                   is "Peter" in the Persons Table?',     -- varchar(500)
